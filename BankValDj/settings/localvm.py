...
import sys
if len(sys.argv) >= 2 and 'runserver' in sys.argv[1] and 'pydevd' not in sys.modules:
    # enable django debug toolbar only under runserver (not uwsgi) and not if running under debugger
